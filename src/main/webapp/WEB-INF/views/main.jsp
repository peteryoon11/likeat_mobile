	...
	<div data-role="page" id="first_main">
		...
		<div data-role="header" data-position="fixed">
			<div data-role="navbar">
				<ul>
					<li><a href="#myPanel" 
						class="ui-btn ui-shadow ui-corner-all ui-btn-icon-left ui-icon-bars"></a>
						<!--     <a href="#myPanel" class="ui-btn ui-btn-inline ui-corner-all ui-shadow">Open Panel</a> -->
						<!--  <button href="#myPanel" class="ui-btn ui-shadow ui-corner-all ui-btn-icon-left ui-icon-bars">bars</button> -->
					</li>
					<li>
					 <c:if test="${ loginfo!=null}">
